package com.godink.springboot.activity5.demo.controller.rest;
...
public class ActivityRestController {
	...
	public void testActivity() {
		...
		//获取流程定义
		ProcessDefinition procDefine = repositoryService.createProcessDefinitionQuery().deploymentId(deploy.getId()).singleResult();
		//启动流程定义，返回流程实例
